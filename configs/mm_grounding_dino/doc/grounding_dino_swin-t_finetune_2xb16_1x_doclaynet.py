...
data_root = '/home/Datasets/DLA/DocLayNet'
class_name = ('Caption', 'Footnote', 'Formula', 'List-item', 'Page-footer', 'Page-header', 'Picture', 'Section-header', 'Table', 'Text', 'Title')
...
train_pipeline = [
    ...
    dict(
        ...
        # TODO a hyperparameter
        num_sample_negative=20,
        label_map_file=data_root + '/COCO/doclaynet_label_map.json',
        max_tokens=256),
    dict(
        type='PackDetInputs',
